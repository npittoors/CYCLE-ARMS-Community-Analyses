...
```
Step 1a: Sequence Processing  [QC_trim_DADA2.md]          ← This repository
            ↓
Step 1b: Taxonomic Assignment  [ARMS_Assign_Taxonomy_Pipeline]  ← Separate repository
            ↓
Step 2: Pre-Taxonomic Diversity Analysis  [FINAL_18S_PreTaxa.Rmd]   ← This repository
            ↓
Step 3: Taxonomic & Differential Abundance Analysis  [PostTaxa_18S.Rmd]   ← This repository
```
...
See: CYCLE-ARMS-Community-Analyses/ARMS_Assign_Taxonomy_Pipeline
...
**Option 1: Full pipeline from CSV inputs**
```r
setwd("path/to/pipeline")
# Open FINAL_18S_PreTaxa.Rmd and execute chunks sequentially
```

**Option 2: Start from pre-built R objects (skip data wrangling)**
```r
load("./metazoan_ASVtab_18S.Rdata")
load("./metadata_ARMS.Rdata")
# Navigate to Part 2 in FINAL_18S_PreTaxa.Rmd
```
...
# Navigate to Part 4 in FINAL_18S_PreTaxa.Rmd
```
